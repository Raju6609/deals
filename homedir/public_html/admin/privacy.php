...
if(isset($_POST['update']))
{
	...
	$data=array("privacy_content"=>mysql_real_escape_string($_POST['ab']));
	$f=array("privacy_id"=>1);
	$me->update(PRIVACY,$data,$f);
    ...
    <body class="fixed-sidebar fixed-header">
        ...
        <div id="page-wrapper" class="demo-example">
            ...
            <h3 class="content-box-header ui-state-default">
                ...
                <span class="float-left toggle-button">PRIVACY Content</span>
        ...
        <div class="form-row pad0B row">
				...
				$getadata=array(
				  ...
				  $updated= $db->select(PRIVACY,$getadata);
			
				?>
                    <form method="post">
<textarea class="large-textarea" name="ab"><?php echo $updated[0]['privacy_content']?></textarea>
