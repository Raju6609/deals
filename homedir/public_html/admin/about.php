...
if(isset($_POST['update']))
{
	...
	$data=array("about_content"=>mysql_real_escape_string($_POST['ab']));
	$f=array("about_id"=>1);
	$me->update(ABOUT,$data,$f);
    ...
    <body class="fixed-sidebar fixed-header">
        ...
        <div id="page-wrapper" class="demo-example">
            ...
            <h3 class="content-box-header ui-state-default">
                ...
                <span class="float-left toggle-button">About Us Content</span>
        ...
        <div class="form-row pad0B row">
				...
				$getadata=array(
				  ...
				  $updated= $db->select(ABOUT,$getadata);
			
				?>
                    <form method="post">
<textarea class="large-textarea" name="ab"><?php echo $updated[0]['about_content']?></textarea>
